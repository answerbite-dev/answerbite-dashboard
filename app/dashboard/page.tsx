      ...
      <main style={{ flex: 1, overflow: "auto" }}>
        <header style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 32px", borderBottom: "1px solid var(--border)", background: "var(--bg-primary)", position: "sticky", top: 0, zIndex: 10 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            <button style={{ color: "var(--text-secondary)", background: "var(--bg-secondary)", border: "1px solid var(--border)", borderRadius: 8, padding: 8, display: "flex", cursor: "pointer" }}>{I.bell}</button>
        ...
        <div style={{ padding: "28px 32px", display: "flex", flexDirection: "column", gap: 24 }}>
          <div style={{ animation: "fadeUp 0.5s ease both" }}>
            ...
            <p style={{ fontSize: 14, color: "var(--text-secondary)", marginTop: 4 }}>Tony&apos;s Pizza — AI phone agent overview</p>
          </div>
          ...
          <div style={{ background: "linear-gradient(135deg, #E8FF5A10, #4ADE8008)", border: "1px solid #E8FF5A30", borderRadius: 14, padding: "24px 28px", display: "flex", alignItems: "center", gap: 20, animation: "fadeUp 0.5s ease both", animationDelay: "0.1s" }}>
            <div style={{ width: 48, height: 48, borderRadius: 12, background: "#E8FF5A15", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, color: "var(--accent)" }}>{I.zap}</div>
            <div style={{ flex: 1 }}>
              <h3 style={{ fontSize: 15, fontWeight: 600, marginBottom: 4 }}>Get your AI agent live</h3>
              <p style={{ fontSize: 13, color: "var(--text-secondary)", lineHeight: 1.5 }}>Set up your menu, hours, and agent config to start answering calls automatically.</p>
            </div>
            <button onClick={() => router.push("/setup")} style={{ padding: "10px 20px", fontSize: 13, fontWeight: 600, borderRadius: 8, background: "var(--accent)", color: "#0a0a0b", border: "none", cursor: "pointer", fontFamily: "inherit", whiteSpace: "nowrap" }}>Complete Setup</button>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            <div style={{ background: "var(--bg-card)", border: "1px solid var(--border)", borderRadius: 14, padding: "22px 24px" }}>
              ...
              <EmptyState icon={<svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72" /></svg>} title="No calls yet" subtitle="Call data will appear here once your AI agent starts handling calls." />
            </div>
            <div style={{ background: "var(--bg-card)", border: "1px solid var(--border)", borderRadius: 14, padding: "22px 24px" }}>
              <h3 style={{ fontSize: 14, fontWeight: 600, marginBottom: 8 }}>Call Outcomes</h3>
              <EmptyState icon={<svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"><circle cx="12" cy="12" r="10" /><line x1="12" y1="8" x2="12" y2="12" /><line x1="12" y1="16" x2="12.01" y2="16" /></svg>} title="No data to display" subtitle="Order, reservation, and FAQ breakdowns will show here." />
            </div>
          </div>

          <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 16 }}>
            <div style={{ background: "var(--bg-card)", border: "1px solid var(--border)", borderRadius: 14, padding: "22px 24px" }}>
              <h3 style={{ fontSize: 14, fontWeight: 600, marginBottom: 16 }}>Recent Calls</h3>
              ...
              <EmptyState icon={<svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 12 16 12 14 15 10 15 8 12 2 12" /><path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z" /></svg>} title="No calls recorded" subtitle="When customers call your restaurant, every conversation will be logged here." />
            </div>
